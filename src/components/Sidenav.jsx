    ...
    <div>
        ...
        <div className='md:block hidden fixed top-[25%] z-10'>
          <div className='flex flex-col'>
            ...
            <a href='#main' className='rounded-full shadow bg-gray-100 shadow-gray-200 m-2 p-4 cursor-pointer hover:scale-110 ease-in duration-300'>
              <AiOutlineHome size={20} />
            </a>

            <a href='#education' className='rounded-full shadow bg-gray-100 shadow-gray-200 m-2 p-4 cursor-pointer hover:scale-110 ease-in duration-300'>
              <FaUniversity size={20} />
            </a>

            <a href='#skills' className='rounded-full shadow bg-gray-100 shadow-gray-200 m-2 p-4 cursor-pointer hover:scale-110 ease-in duration-300'>
              <BsPerson size={20} />
            </a>

            <a href='#projects' className='rounded-full shadow bg-gray-100 shadow-gray-200 m-2 p-4 cursor-pointer hover:scale-110 ease-in duration-300'>
              <AiOutlineProject size={20} />
            </a>

            <a href='#contact' className='rounded-full shadow bg-gray-100 shadow-gray-200 m-2 p-4 cursor-pointer hover:scale-110 ease-in duration-300'>
              <AiOutlineMail size={20} />
            </a>
          </div>
        </div>
